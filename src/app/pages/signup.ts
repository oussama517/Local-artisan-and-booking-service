  ...
  template: `
    <div class="min-h-screen bg-gray-50 flex flex-col justify-center py-12 sm:px-6 lg:px-8 pt-24">
      <div class="sm:mx-auto sm:w-full sm:max-w-md text-center" #header>
        ...
        <h2 class="text-center text-3xl font-display font-bold text-gray-900 tracking-tight">Create an account</h2>
        <p class="mt-2 text-center text-sm text-gray-600">
          Already have an account? 
          <a routerLink="/login" class="font-medium text-primary-600 hover:text-primary-500 transition-colors">Log in</a>
        </p>
      </div>

      <div class="mt-8 sm:mx-auto sm:w-full sm:max-w-md" #signupCard>
        <div class="bg-white py-8 px-4 shadow-xl shadow-gray-200/50 sm:rounded-3xl sm:px-10 border border-gray-100">
          ...
          <div class="flex p-1 bg-gray-100 rounded-xl mb-8">
            <button type="button" (click)="setRole('customer')"
              [class]="role === 'customer' ? 'flex-1 py-2 text-sm font-medium rounded-lg transition-all shadow-sm bg-white text-gray-900' : 'flex-1 py-2 text-sm font-medium rounded-lg transition-all text-gray-500 hover:text-gray-700'">
              I'm a Customer
            </button>
            <button type="button" (click)="setRole('artisan')"
              [class]="role === 'artisan' ? 'flex-1 py-2 text-sm font-medium rounded-lg transition-all shadow-sm bg-white text-gray-900' : 'flex-1 py-2 text-sm font-medium rounded-lg transition-all text-gray-500 hover:text-gray-700'">
              I'm an Artisan
            </button>
          </div>
          ...
          <form class="space-y-5" action="#" method="POST">
            <div>
              ...
              <div class="mt-1 relative">
                ...
                <input id="name" name="name" type="text" required class="appearance-none block w-full pl-10 pr-3 py-3 border border-gray-200 rounded-xl shadow-sm placeholder-gray-400 focus:outline-none focus:ring-primary-500 focus:border-primary-500 sm:text-sm transition-all bg-gray-50 focus:bg-white" placeholder="John Doe">
              </div>
            </div>
            ...
            <div>
              ...
              <div class="mt-1 relative">
                ...
                <input id="password" name="password" type="password" autocomplete="new-password" required class="appearance-none block w-full pl-10 pr-3 py-3 border border-gray-200 rounded-xl shadow-sm placeholder-gray-400 focus:outline-none focus:ring-primary-500 focus:border-primary-500 sm:text-sm transition-all bg-gray-50 focus:bg-white" placeholder="••••••••">
              </div>
            ...
            @if (role === 'artisan') {
              <div>
                ...
                <div class="mt-1 relative">
                  <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                    <mat-icon class="text-gray-400 text-[20px] w-[20px] h-[20px]">work</mat-icon>
                  </div>
                  <select id="category" name="category" required class="appearance-none block w-full pl-10 pr-3 py-3 border border-gray-200 rounded-xl shadow-sm focus:outline-none focus:ring-primary-500 focus:border-primary-500 sm:text-sm transition-all bg-gray-50 focus:bg-white text-gray-900">
              ...
              <div>
                ...
                <div class="mt-1 relative">
                  <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                    <mat-icon class="text-gray-400 text-[20px] w-[20px] h-[20px]">phone</mat-icon>
                  </div>
                  <input id="phone" name="phone" type="tel" required class="appearance-none block w-full pl-10 pr-3 py-3 border border-gray-200 rounded-xl shadow-sm placeholder-gray-400 focus:outline-none focus:ring-primary-500 focus:border-primary-500 sm:text-sm transition-all bg-gray-50 focus:bg-white" placeholder="(555) 123-4567">
                </div>
              </div>
            }

            <div class="flex items-center">
              <input id="terms" name="terms" type="checkbox" required class="h-4 w-4 text-primary-600 focus:ring-primary-500 border-gray-300 rounded cursor-pointer">
...
export class SignupComponent implements AfterViewInit {
  ...
  setRole(newRole: 'customer' | 'artisan') {
    this.role = newRole;
  }
